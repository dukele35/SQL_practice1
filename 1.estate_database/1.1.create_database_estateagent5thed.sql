...
# To create the database "estateagent5thEd", run only the line below. After that, lock that line and run the rest
# create database estateagent5thEd; 

# After creating the database, run the rest of codes below
